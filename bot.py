...
token = '6141308307:AAHNZ_cVJukSVJ8YkHfudkH2fq09KJveGSg'
bot = Bot(token)
IN = range(1)
form = """
...
def start(update,context):
    ...
    context.bot.send_message(chat_id=update.message.chat_id, 
        text="Wellcome to CaTranslatorBot. Mr/Mrs "+ update.message.from_user.first_name+ " Chapi's Always Favorite and Bestie")
